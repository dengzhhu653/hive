...
public record SearchConfig(Configuration configuration) {
  ...
  public static final String HYBRID_MATCH_WEIGHT = "metastore.search.hybrid.match.weight";
  public static final float HYBRID_MATCH_WEIGHT_DEFAULT = 0.6f;
  ...
  public float getHybridMatchWeight() {
    return configuration.getFloat(HYBRID_MATCH_WEIGHT, HYBRID_MATCH_WEIGHT_DEFAULT);
  }

  public float getHybridSemanticWeight() {
    return configuration.getFloat(HYBRID_SEMANTIC_WEIGHT, HYBRID_SEMANTIC_WEIGHT_DEFAULT);
  }
