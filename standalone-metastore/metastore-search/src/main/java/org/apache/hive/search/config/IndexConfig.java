...
public record IndexConfig(Configuration configuration) {
  ...
  public static final int INDEX_RAM_SIZE_DEFAULT = 32 * 1024 * 1024;

  public static final String FLUSH_INTERVAL_MS = "metastore.index.flush.interval.ms";
  public static final long FLUSH_INTERVAL_MS_DEFAULT = 5000L;
  ...
  public static final long POLL_NOTIFICATION_INTERVAL_DEFAULT = 3000;

  public static final String INDEX_SYNC_INTERVAL = "metastore.index.sync.interval.minutes";
  public static final long INDEX_SYNC_INTERVAL_DEFAULT = 3 * 60;
  ...
  /** Partial-bootstrap Lucene commits during leader rebuild. */
  public static final String BOOTSTRAP_FLUSH_BATCHES = "metastore.index.bootstrap.flush.batches";
  public static final int BOOTSTRAP_FLUSH_BATCHES_DEFAULT = 100;
  ...
  public static final long EVENT_UNHEALTHY_BACKOFF_MS_DEFAULT = 30 * 60 * 1000L;
  ...
  public int getBootstrapFlushBatches() {
    return configuration.getInt(BOOTSTRAP_FLUSH_BATCHES, BOOTSTRAP_FLUSH_BATCHES_DEFAULT);
  }
