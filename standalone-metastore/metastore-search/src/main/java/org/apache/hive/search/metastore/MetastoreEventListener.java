...
public interface MetastoreEventListener {
   ...
   */
  default void notifyTask(NotificationTask task) throws IndexException, java.io.IOException {

  }

  default void notifyStatus(boolean healthy, IndexNotHealthyException... e) {
