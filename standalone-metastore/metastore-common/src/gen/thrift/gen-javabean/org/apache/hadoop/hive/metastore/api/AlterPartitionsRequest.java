...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class AlterPartitionsRequest implements org.apache.thrift.TBase<AlterPartitionsRequest, AlterPartitionsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AlterPartitionsRequest> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitions = new java.util.ArrayList<Partition>(_list1460.size);
                @org.apache.thrift.annotation.Nullable Partition _elem1461;
                for (int _i1462 = 0; _i1462 < _list1460.size; ++_i1462)
                {
                  _elem1461 = new Partition();
                  _elem1461.read(iprot);
                  struct.partitions.add(_elem1461);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // PARTITION_COL_SCHEMA
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1463 = iprot.readListBegin();
                struct.partitionColSchema = new java.util.ArrayList<FieldSchema>(_list1463.size);
                @org.apache.thrift.annotation.Nullable FieldSchema _elem1464;
                for (int _i1465 = 0; _i1465 < _list1463.size; ++_i1465)
                {
                  _elem1464 = new FieldSchema();
                  _elem1464.read(iprot);
                  struct.partitionColSchema.add(_elem1464);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AlterPartitionsRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitions != null) {
        oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
        {
          ...
          for (Partition _iter1466 : struct.partitions)
          {
      ...
      if (struct.partitionColSchema != null) {
        if (struct.isSetPartitionColSchema()) {
          oprot.writeFieldBegin(PARTITION_COL_SCHEMA_FIELD_DESC);
          {
            ...
            for (FieldSchema _iter1467 : struct.partitionColSchema)
            {
  ...
  private static class AlterPartitionsRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<AlterPartitionsRequest> {
      ...
      if (struct.isSetPartitionColSchema()) {
        {
          ...
          for (FieldSchema _iter1469 : struct.partitionColSchema)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, AlterPartitionsRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setTableNameIsSet(true);
      {
        org.apache.thrift.protocol.TList _list1470 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.partitions = new java.util.ArrayList<Partition>(_list1470.size);
        @org.apache.thrift.annotation.Nullable Partition _elem1471;
        for (int _i1472 = 0; _i1472 < _list1470.size; ++_i1472)
        {
          _elem1471 = new Partition();
          _elem1471.read(iprot);
          struct.partitions.add(_elem1471);
        }
      }
      struct.setPartitionsIsSet(true);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.partitionColSchema = new java.util.ArrayList<FieldSchema>(_list1473.size);
          @org.apache.thrift.annotation.Nullable FieldSchema _elem1474;
          for (int _i1475 = 0; _i1475 < _list1473.size; ++_i1475)
          {
            _elem1474 = new FieldSchema();
            _elem1474.read(iprot);
            struct.partitionColSchema.add(_elem1474);
          }
        }
        struct.setPartitionColSchemaIsSet(true);
      }
