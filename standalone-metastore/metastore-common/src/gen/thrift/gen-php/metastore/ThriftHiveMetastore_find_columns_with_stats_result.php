...
class ThriftHiveMetastore_find_columns_with_stats_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1998 = 0;
                        $_etype2001 = 0;
                        $xfer += $input->readListBegin($_etype2001, $_size1998);
                        for ($_i2002 = 0; $_i2002 < $_size1998; ++$_i2002) {
                            $elem2003 = null;
                            $xfer += $input->readString($elem2003);
                            $this->success []= $elem2003;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2004) {
                $xfer += $output->writeString($iter2004);
            }
            $output->writeListEnd();
