...
class ThriftHiveMetastore_get_partitions_by_filter_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size1829 = 0;
                        $_etype1832 = 0;
                        $xfer += $input->readListBegin($_etype1832, $_size1829);
                        for ($_i1833 = 0; $_i1833 < $_size1829; ++$_i1833) {
                            $elem1834 = null;
                            $elem1834 = new \metastore\Partition();
                            $xfer += $elem1834->read($input);
                            $this->success []= $elem1834;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter1835) {
                $xfer += $iter1835->write($output);
            }
            $output->writeListEnd();
