...
class ThriftHiveMetastore_get_all_packages_result
{
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        $_size2026 = 0;
                        $_etype2029 = 0;
                        $xfer += $input->readListBegin($_etype2029, $_size2026);
                        for ($_i2030 = 0; $_i2030 < $_size2026; ++$_i2030) {
                            $elem2031 = null;
                            $xfer += $input->readString($elem2031);
                            $this->success []= $elem2031;
                        }
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            foreach ($this->success as $iter2032) {
                $xfer += $output->writeString($iter2032);
            }
            $output->writeListEnd();
